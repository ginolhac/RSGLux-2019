...
## Tidyverse | workflow {.vs1}

### Pipeline {.col-9 .center-pic}
...
```{r, title = "Explicit", width = 6, class = "stretch"}
v_example <- c(1, 3, 7)
...
### Work with lists ([Cheatsheet](https://www.rstudio.org/links/purrr_cheat_sheet)) {.box-12 .intro .outline}

![](img/10/work_with_lists.png)
...
- Rstudio's blog - [purrr 0.1 release](https://blog.rstudio.org/2015/09/29/purrr-0-1-0/), [purrr 0.2 release](https://blog.rstudio.org/2016/01/06/purrr-0-2-0/)
...
### Acknowledgments {.box-10 .offset-1 .intro}
