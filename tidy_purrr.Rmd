...
## Slides online {.build .vs2}

### on github {.box-8 .offset-2 .intro .outline .show .x-large .center-text}

- [tidy data and functional programming](XX)

### See you next week! {.box-8 .offset-2 .practical .outline .center-text}
